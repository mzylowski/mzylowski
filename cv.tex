...
\definecolor{linkColor}{HTML}{AA4B41}
...
\definecolor{VividPurple}{HTML}{335252}
\definecolor{SlateGrey}{HTML}{2D3033}
\definecolor{LightGrey}{HTML}{D4DDE1}
...
\begin{document}
\name{Michał Żyłowski}
\tagline{Clound Engineer at Intel Corporation \break The open source philosophy believer}
\photo{2.5cm}{mz}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{michal@zylowski.net}
  \phone{000-000-000} %private-data
  \location{Gdansk, Poland}
  \homepage{\href{https://zylowski.net}{zylowski.net}}
  \linkedin{\href{https://www.linkedin.com/in/micha\%C5\%82-\%C5\%BCy\%C5\%82owski-6ba824110/}{linkedin.com/in/mzylowski}}
  \github{\href{https://github.com/mzylowski}{github.com/mzylowski}}
}
