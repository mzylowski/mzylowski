...
{\portfoliohref{https://github.com/kubernetes-sigs/kubespray/pull/852}{PR to Kubespray} | \portfoliohref{https://github.com/kubernetes-sigs/kubespray/issues/610}{Issue submitted to Kargo} | \portfoliohref{https://github.com/kubernetes/kubernetes/pull/35302}{k8s e2e test fix}}{-----}

\portfolioitem{2015/11 - 2016/09}{Serenity (plugin for Mesos)}{Tester}{img/k8s.png}{0.8}
